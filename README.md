...
- [Archives for Parachains](#archives-for-parachains)
- [Local archive](#setup-your-own-archive)
...
Squid framework provides tools for the generation of type-safe, 
spec version aware wrappers around events, calls and runtime storage items. 
...
Generation of type-safe wrappers for events, calls and storage items is
performed by `squid-substrate-typegen(1)`, which expects a
